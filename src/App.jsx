...
import { Settings, Users, GraduationCap, RotateCcw, Minus, Plus, Trophy, AlertCircle } from 'lucide-react';
        ...
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleConfigSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-slate-600 mb-1">Total Alunos</label>
                <input 
                  required
                  type="number" 
                  min="1"
              ...
              <div>
                <label className="block text-sm font-medium text-slate-600 mb-1">Total Servidores</label>
                <input 
                  required
                  type="number" 
                  min="1"
      ...
      <header className="bg-white shadow-sm border-b border-slate-200 sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="bg-slate-100 text-slate-600 px-2 py-1 rounded text-xs font-mono sm:hidden">
              VOTAÇÃO
            </span>
          </div>
          <button 
